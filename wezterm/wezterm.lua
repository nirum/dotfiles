...
config["window_frame"] = {font = wezterm.font({family = "Helvetica Neue", weight = "Bold"}), font_size = 14.0}
config["hide_tab_bar_if_only_one_tab"] = false
config["tab_bar_at_bottom"] = false
config["use_fancy_tab_bar"] = false
config["tab_and_split_indices_are_zero_based"] = false
config["background"] = {{source = {File = "/Users/niru/dotfiles/images/gradient.png"}, hsb = {hue = 1.0, saturation = 1.02, brightness = 0.25}}}
return config
